  ...
  return (
    <tr>
      ...
      <td className={`table-title ${task.completed ? "task-completed" : ""}`}>
        {isEditRow ? 
          <input type="text" value={title} onChange={(event) => handleTitle(event.target.value)}></input> 
          : task.title}
      </td>
      <td className={`table-content ${task.completed ? "task-completed" : ""}`}>
        {isEditRow ? 
          <input type="text" value={content} onChange={(event) => handleContent(event.target.value)}></input> 
          : task.content}
      </td>
      <td className={`table-deadline ${task.completed ? "task-completed" : ""}`}>
        {isEditRow ? 
          <input type="date" value={deadline} onChange={(event) => handleDeadline(event.target.value)}></input>
          : task.deadline}
      </td>
