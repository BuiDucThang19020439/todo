            ...
            <Form noValidate validated={validated} onSubmit={handleSubmitWeatherForm}>
                <Row>
                    <FormGroup as={Col}>
                        ...
                        <FormControl type="text" defaultValue={"Hanoi"} onChange={(event => { setCity(event.target.value) })}></FormControl>
                    </FormGroup>
                    <FormGroup as={Col}>
                        <FormLabel>Quốc gia</FormLabel>
                        <FormControl type="text" defaultValue={"Vietnam"} onChange={(event) => { setCountry(event.target.value) }}></FormControl>
                    </FormGroup>
